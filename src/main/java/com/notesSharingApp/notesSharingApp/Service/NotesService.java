...
//    private Cloudinary cloudinary;
    ...
    public void uploadNote(MultipartFile thumbnail, MultipartFile notes, UploadNoteDTO note,HttpServletRequest request) throws IOException,FileTooBig{
      ...
      if(notes.getSize()/(1024 * 1024) > 20){
            throw new FileTooBig("Only 20mb pdf file size is allowed");
      }
      ...
      ZoneId zoneId = ZoneId.of(request.getHeader("user-TimeZone"));
